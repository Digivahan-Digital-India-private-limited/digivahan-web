      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Add, update, delete, or view QR code benefits
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-gray-600">Create a new QR benefit</p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600">Modify existing QR benefit</p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600">Remove a QR benefit</p>
          </div>

          {/* Check All QR Benefits */}
          <div
            onClick={() => navigate("")}
          ...
          >
            ...
            <p className="text-gray-600">View all QR benefits</p>
          </div>
        </div>
      </div>
    </div>
...
export default ManageQRBenefits;
