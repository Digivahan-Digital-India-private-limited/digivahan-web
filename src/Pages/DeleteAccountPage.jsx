...
const DeleteAccountPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setLoading(false);
      setSuccess(
        "Your account deletion request has been submitted. Our team will process it within 3–7 working days.",
      );
      setFormData({
        full_name: "",
        mobile: "",
  ...
  const retentionItems = [
    {
      ...
      desc: "Data required by law for regulatory purposes.",
    },
    {
      icon: "🛡️",
      title: "Fraud Prevention",
      desc: "Information needed to detect or prevent fraud.",
    },
    {
      icon: "📋",
      title: "Regulatory Obligations",
      desc: "Records mandated by applicable regulations.",
    },
    {
      icon: "🔍",
      title: "Dispute Resolution",
      desc: "Data required to resolve pending disputes.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      a: "No. Once your account is deleted, this action is irreversible. All data is permanently removed and cannot be recovered.",
    },
    {
      q: "How long does the deletion process take?",
      a: "Account deletion requests are typically processed within 3–7 working days after identity verification.",
    },
    {
      q: "Will I receive a confirmation after deletion?",
      a: "Yes. You may receive a confirmation via email or SMS once your account has been successfully deleted.",
    },
    {
      q: "What happens to my active orders or services?",
      a: "We recommend resolving all active orders and service requests before submitting a deletion request to avoid complications.",
    },
    {
      q: "Why is some data retained after deletion?",
      a: "Certain data may be retained for legal compliance, fraud prevention, regulatory obligations, or dispute resolution as required by law.",
    },
  ];
    ...
    <>
      ...
      <div className="min-h-screen bg-linear-to-br from-gray-50 via-white to-red-50">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="fade-in-left space-y-6">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  At Digivahan, we respect your right to control your personal
                  data. If you wish to permanently delete your account, you can
                  request account deletion through this page.
                </p>
                <p>
                  We aim to provide a transparent and secure process for
                  handling such requests. Before proceeding, please read through
                  all the information carefully.
                </p>
                <p>
                  Once your request is verified, our team will process it within
                  a defined timeframe. This action is{" "}
                  <strong>irreversible</strong> — any data associated with your
                  account will be permanently removed.
                </p>
                <p>
                  If you're unsure about deleting your account, consider
                  reaching out to our support team first. We may be able to
                  resolve your concern without requiring account deletion.
                </p>
              </div>
        ...
        <div className="bg-red-50 py-14">
          <div className="max-w-7xl mx-auto px-4">
            <div ref={setRef("warn")} className="scroll-anim text-center mb-10">
              <span className="inline-block px-4 py-1.5 bg-red-100 text-red-700 text-sm font-semibold rounded-full mb-3">
                Important
              </span>
              ...
              <p className="text-gray-500 mt-2 max-w-xl mx-auto">
                Please note the following before submitting your deletion
                request:
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-5 max-w-4xl mx-auto">
              {warnings.map((warn, i) => (
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-red-100 flex items-center justify-center shrink-0 text-red-500 font-bold text-sm">
                    {i + 1}
                  </div>
        ...
        <div className="bg-white py-14">
          <div className="max-w-7xl mx-auto px-4">
            <div
              ref={setRef("stepsTitle")}
              className="scroll-anim text-center mb-12"
            >
              <span className="inline-block px-4 py-1.5 bg-yellow-100 text-yellow-700 text-sm font-semibold rounded-full mb-3">
                Process
              </span>
              <h2 className="text-3xl font-bold text-gray-900">
            ...
            <div
              ref={setRef("ctaStep")}
              className="scroll-anim text-center mt-10"
            >
              <button
                onClick={() => setIsModalOpen(true)}
        ...
        <div className="bg-linear-to-br from-gray-900 to-gray-800 py-14">
          <div className="max-w-7xl mx-auto px-4">
            <div
              ref={setRef("timeline")}
              className="scroll-anim text-center mb-10"
            >
              ...
              {[
                {
                  ...
                  desc: "Account deletion requests are typically processed within 3–7 working days.",
                },
                {
                  icon: "📩",
                  title: "Confirmation Notice",
                  desc: "You may receive a confirmation via email or SMS once your account has been successfully deleted.",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  ref={setRef(`tl${i}`)}
                  className={`scroll-anim delay-t${i + 1} bg-white/10 border border-white/20 rounded-2xl p-6 text-center backdrop-blur-sm hover:bg-white/20 transition-all duration-300 hover:-translate-y-1`}
                >
        ...
        <div className="bg-white py-14">
          <div className="max-w-7xl mx-auto px-4">
            <div
              ref={setRef("retention")}
              className="scroll-anim text-center mb-12"
            >
              <span className="inline-block px-4 py-1.5 bg-blue-100 text-blue-700 text-sm font-semibold rounded-full mb-3">
                Policy
              </span>
              <h2 className="text-3xl font-bold text-gray-900">
                📦 Data Retention Policy
              ...
              <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
                While your account will be deleted, certain information may be
                retained for a limited period if required for:
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {retentionItems.map((item, i) => (
                <div
                  key={i}
                  ref={setRef(`ret${i}`)}
                  className={`scroll-anim delay-t${i + 1} retention-card bg-linear-to-br from-blue-50 to-white border border-blue-100 rounded-2xl p-6 text-center shadow-md`}
                >
                  <div className="text-4xl mb-3">{item.icon}</div>
            ...
            <div
              ref={setRef("retNote")}
              className="scroll-anim mt-8 max-w-3xl mx-auto bg-blue-50 border border-blue-200 rounded-2xl p-5"
            >
              <p className="text-blue-700 text-sm text-center font-medium">
                🔒 Such data will be securely stored and{" "}
                <strong>not used for marketing purposes</strong>.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-red-50 py-14">
          <div className="max-w-7xl mx-auto px-4">
            <div
              ref={setRef("help")}
              className="scroll-anim max-w-3xl mx-auto text-center"
            >
              <div className="bg-white rounded-3xl p-8 shadow-lg border border-red-100">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  If you are facing issues with your account and do not wish to
                  delete it, we recommend contacting our support team first. We
                  may be able to resolve your concern without deleting your
                  account.
                </p>
                <div className="flex flex-wrap justify-center gap-4">
                  <a
                    href="/contact-page"
                    className="bg-yellow-500 hover:bg-yellow-600 text-white font-bold px-6 py-3 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg"
                  >
                    Contact Support
                  </a>
                  <a
                    href="/Raise-concern-page"
                    className="bg-white hover:bg-gray-50 text-gray-700 font-bold px-6 py-3 rounded-xl border border-gray-200 transition-all duration-300 hover:scale-105 hover:shadow-lg"
                  >
                    Raise a Concern
                  </a>
                </div>
              ...
              {faqs.map((faq, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <span
                      className={`text-yellow-500 font-bold text-xl shrink-0 transition-transform duration-300 ${openFaq === i ? "rotate-45" : ""}`}
                    >
                      +
                    </span>
                  </button>
        ...
        <div
          ref={setRef("cta")}
          className="scroll-anim bg-linear-to-r from-red-500 to-red-600 py-14 text-center"
        >
          <div className="max-w-2xl mx-auto px-4">
            ...
            <p className="text-red-100 mb-7">
              This action is permanent and cannot be undone. Please make sure
              you've read all the information above before proceeding.
            </p>
            <button
              onClick={() => setIsModalOpen(true)}
          ...
          <div className="relative bg-white w-full max-w-2xl rounded-2xl shadow-2xl p-6 sm:p-8 max-h-[90vh] overflow-y-auto modal-slide-in">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-gray-500 text-sm mt-2">
                Please fill in the details below to submit your deletion
                request.
              </p>
            </div>
            ...
            <div className="mb-5 p-4 bg-red-50 border-l-4 border-red-500 rounded-lg">
              <p className="text-red-700 text-sm font-semibold">
                ⚠️ Warning: This action is permanent and irreversible. All your
              ...
              <div className="bg-red-50 border border-red-200 rounded-xl p-4">
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-red-700 leading-relaxed">
                    ...
                    vehicle records, and account information will be permanently
                    deleted. I confirm that I want to proceed with the account
                    deletion request.
                  </span>
                </label>
              </div>
