  ...
  const [reviews] = useState([
    {
      ...
      review: 'Bahut achha service hai!',
      rating: 5
    },
    {
      customerId: 'CU-5678',
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-800">Positive Reviews</h1>
            ...
            <tbody className="divide-y divide-gray-200">
              {reviews.map((review, index) => (
                <tr key={index} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1 px-3 py-1 bg-green-100 rounded-lg w-fit">
