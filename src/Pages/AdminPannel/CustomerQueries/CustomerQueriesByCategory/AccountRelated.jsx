              ...
              {queries.map((query) => (
                <tr key={query.id} className="hover:bg-gray-50 transition">
                  ...
                  <td className="px-6 py-4">
                    <button onClick={() => navigate('/customer-queries/reply', { state: { query } })} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition font-medium flex items-center gap-2">
