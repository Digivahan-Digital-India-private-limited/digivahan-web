    ...
    <main className="w-full min-h-screen overflow-y-auto bg-white md:p-6 p-3">
      <header className="bg-white rounded-lg shadow-sm p-4 mb-6 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          <button className="relative text-xl">ðŸ””<span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs w-4 h-4 rounded-full flex items-center justify-center">1</span></button>
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div><h1 className="text-2xl md:text-3xl font-semibold text-gray-900">Payment / Billing</h1><p className="text-sm text-gray-600">Total queries: {queries.length}</p></div>
        </div>
      </div>
