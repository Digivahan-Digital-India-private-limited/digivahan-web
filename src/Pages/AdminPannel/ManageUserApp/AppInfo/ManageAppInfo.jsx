      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Add, update, delete, or view app information
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-gray-600">Create new app information</p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600">Modify existing app info</p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600">Remove app information</p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600">View all app information</p>
          </div>
        </div>
      </div>
    </div>
