    ...
    <main className="w-full min-h-screen overflow-y-auto bg-white md:p-6 p-3">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div><h1 className="text-2xl md:text-3xl font-semibold text-gray-900">Cancellation / Return</h1><p className="text-sm text-gray-600">Total queries: {queries.length}</p></div>
        </div>
      </div>
