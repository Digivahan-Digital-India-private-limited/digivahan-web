  ...
  const [reviews] = useState([
    {
      ...
      review: 'Theek hai, improvement chahiye.',
      rating: 3
    },
    {
      customerId: 'CU-6789',
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-800">Average Reviews</h1>
            ...
            <tbody className="divide-y divide-gray-200">
              {reviews.map((review, index) => (
                <tr key={index} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1 px-3 py-1 bg-yellow-100 rounded-lg w-fit">
