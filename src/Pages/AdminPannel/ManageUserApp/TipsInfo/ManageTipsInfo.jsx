      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Add, update, delete, or view helpful tips
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-gray-600">Create a new tip</p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600">Modify existing tips</p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600">Remove a tip</p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600">View all tips</p>
          </div>
        </div>
      </div>
    </div>
